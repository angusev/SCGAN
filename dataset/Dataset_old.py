...
class InpaintDataset(Dataset):
    ...
    def __init__(self, root_folder, split, image_size, bbox_shape, bbox_randomness, bbox_margin, bbox_max_num, is_overfit):
        ...
        with open(os.path.join(constants.DATASET_ROOT, constants.SPLITS_FOLDER, split + ".txt"),"r") as fptr:
    ...
    def __getitem__(self, index):
        ...
        image = Image.open(os.path.join(constants.DATASET_ROOT,
                                        constants.IMAGES_FOLDER,
                                        file + ".jpg"))
        sketch = Image.open(os.path.join(constants.DATASET_ROOT,
                                        constants.SKETCHES_FOLDER,
                                        file + ".jpg"))
        colormap = Image.open(os.path.join(constants.DATASET_ROOT,
                                        constants.COLORMAPS_FOLDER,
                                        file + ".png"))
