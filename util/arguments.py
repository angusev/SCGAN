...
def parse_arguments():
    ...
    # dataset
    parser.add_argument(
        "--dataset", type=str, default="matterport", help="dataset name"
    )
    parser.add_argument("--num_workers", type=int, default=2, help="num workers")
    parser.add_argument("--image_size", type=int, default=256, help="input image size")
    parser.add_argument("--bbox_shape", type=int, default=48, help="random box size")
    parser.add_argument(
        "--bbox_randomness", type=float, default=0.25, help="variation in box size"
    )
    parser.add_argument(
        "--bbox_margin", type=int, default=32, help="margin from boundaries for box"
    )
    parser.add_argument("--bbox_max_num", type=int, default=2, help="max num of boxes")
    parser.add_argument(
        "--fixed_bbox_idx", type=int, default=0, help="boxes to be used for testing"
    )
    parser.add_argument(
        "--vis_dataset",
        type=str,
        default="vis_0",
        help="images to be visualized after each epoch",
    )
    parser.add_argument("--overfit", default=False, action="store_true")

    # train params
    parser.add_argument(
        "--max_epoch", type=int, default=200, help="number of epochs to train for"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--gen_loss_alpha", type=float, default=0.005, help="generator loss lambda"
    )
    parser.add_argument(
        "--disc_loss_alpha", type=float, default=1.0, help="discriminator loss lambda"
    )
    parser.add_argument(
        "--refined_as_discriminator_input", default=False, action="store_true"
    )
    parser.add_argument(
        "--gen_type", type=str, choices=["GSAGAN", "UNet"], default="UNet"
    )
    ...
    parser.add_argument(
        "--no_intermediate_input_filling", default=False, action="store_true"
    )
    ...
    parser.add_argument(
        "--experiment", type=str, default="fast_dev", help="experiment directory"
    )
    parser.add_argument(
        "--visualization_set",
        type=str,
